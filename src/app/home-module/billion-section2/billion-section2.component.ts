...
@Component({
  selector: 'app-billion-section2',
  templateUrl: './billion-section2.component.html',
  styleUrls: ['./billion-section2.component.scss']
})
export class BillionSection2Component implements OnInit {
