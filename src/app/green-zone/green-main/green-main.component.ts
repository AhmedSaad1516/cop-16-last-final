...
import { RegisterMainComponent } from 'src/app/register-green-zone/register-main/register-main.component';
...
@Component({
  ...
  styleUrls: ['./green-main.component.scss']
})
export class GreenMainComponent  {
  ...
  openForm(){
    ...
    const dialogRef = this.dialog.open(RegisterMainComponent, {
      width:'40%',
      height:'70%',
      disableClose : true,
        });
